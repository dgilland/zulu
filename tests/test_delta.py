...
@parametrize(
    ...
    [
        ...
        ("4:13:02.266", Delta(hours=4, minutes=13, seconds=2, microseconds=266000)),
        (
            "2:04:13:02.266",
        ...
        ("5 hours, 34 minutes, 56 seconds", Delta(hours=5, minutes=34, seconds=56)),
        ("5 hrs, 34 mins, 56 secs", Delta(hours=5, minutes=34, seconds=56)),
        (
            "2 days, 5 hours, 34 minutes, 56 seconds",
            Delta(days=2, hours=5, minutes=34, seconds=56),
        ),
...
@parametrize("obj,exception", [({}, TypeError), ("", ParseError), ("a", ParseError)])
...
@parametrize(
    "opts,exception",
    [({"granularity": "invalid"}, ValueError), ({"format": "invalid"}, ValueError)],
)

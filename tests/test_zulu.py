...
@parametrize(
    "obj,expected",
    [
        ("2000", datetime(2000, 1, 1, tzinfo=UTC)),
        ({"year": 2000}, datetime(2000, 1, 1, tzinfo=UTC)),
        ("2000-01", datetime(2000, 1, 1, tzinfo=UTC)),
        ({"year": 2000, "month": 1}, datetime(2000, 1, 1, tzinfo=UTC)),
        ("2000-01-01", datetime(2000, 1, 1, tzinfo=UTC)),
        ({"year": 2000, "month": 1, "day": 1}, datetime(2000, 1, 1, tzinfo=UTC)),
        ("2000-03-05", datetime(2000, 3, 5, tzinfo=UTC)),
        ({"year": 2000, "month": 3, "day": 5}, datetime(2000, 3, 5, tzinfo=UTC)),
        ("2000-01-01T12:30", datetime(2000, 1, 1, 12, 30, tzinfo=UTC)),
        (
            {"year": 2000, "month": 1, "day": 1, "hour": 12, "minute": 30},
            datetime(2000, 1, 1, 12, 30, tzinfo=UTC),
        ),
        ("2000-01-01 12:30", datetime(2000, 1, 1, 12, 30, tzinfo=UTC)),
        ("2000-01-01T12:30:30", datetime(2000, 1, 1, 12, 30, 30, tzinfo=UTC)),
        (
            {
                "year": 2000,
                "month": 1,
        ...
        ("2000-01-01T12:30:30-0400", datetime(2000, 1, 1, 16, 30, 30, tzinfo=UTC)),
        (
            {
                "year": 2000,
                "month": 1,
        ...
        ("2000-01-01T12:00:00-2359", datetime(2000, 1, 2, 11, 59, tzinfo=UTC)),
        (
            {
                "year": 2000,
                "month": 1,
        ...
        ("2000-01-01T12:00:00+2359", datetime(1999, 12, 31, 12, 1, tzinfo=UTC)),
        (
            {
                "year": 2000,
                "month": 1,
...
@parametrize(
    ...
    [
        ...
        (
            ...
            {"formats": ("%Y %y %B %b %m %j %d %A %a %w " "%H %I %M %S %f %p")},
...
@parametrize(
    ...
    [
        ...
        (Zulu(2000, 1, 5, 13, 7, 8, 123456), {"format": "EEE", "locale": "fr"}, "mer."),
...
@parametrize(
    ...
    [
        ...
        (Zulu(2000, 1, 1, 12, 30), {"tz": "US/Eastern"}, "2000-01-01T07:30:00-05:00"),
        (Zulu(2000, 1, 1, 12, 30), {"format": "%a %b %d"}, "Sat Jan 01"),
    ],
)
...
@parametrize(
    "dt,fmt,expected",
    [
        (Zulu(2000, 1, 1, 12, 30), "%Y-%m-%dT%H:%M:%S%z", "2000-01-01T12:30:00+0000"),
        (Zulu(2000, 1, 1, 12, 30), "%a %b %d", "Sat Jan 01"),
    ],
)
...
@parametrize(
    "string,fmt,expected",
    [("2000-01-01T12:30:00", "%Y-%m-%dT%H:%M:%S", Zulu(2000, 1, 1, 12, 30))],
)
...
@parametrize(
    "dt,expected",
    [
        (eastern.localize(datetime(2000, 1, 1)), datetime(2000, 1, 1, 5, tzinfo=UTC)),
        (Zulu(2000, 1, 1, tzinfo="UTC"), datetime(2000, 1, 1, tzinfo=UTC)),
    ],
)
...
@parametrize(
    "date,time,expected",
    [
        (datetime(2000, 1, 1), time(12, 30), Zulu(2000, 1, 1, 12, 30)),
        (date(2000, 1, 1), time(12, 30), Zulu(2000, 1, 1, 12, 30)),
        (Zulu(2000, 1, 1), Zulu(1990, 12, 3, 12, 30), Zulu(2000, 1, 1, 12, 30)),
    ],
)
...
@parametrize(
    ...
    [
        ...
        ("subtract", Zulu(2000, 1, 1), relativedelta(days=1), Zulu(1999, 12, 31)),
...
@parametrize(
    ...
    [
        ...
        (Zulu(2000, 1, 1, 0, 0, 0), Zulu(2000, 1, 1, 0, 0, 1), "in 1 second"),
        (Zulu(2000, 1, 1, 0, 0, 1), Zulu(2000, 1, 1, 0, 0, 0), "1 second ago"),
        (Zulu(2000, 1, 1, 0, 0, 0, 0), Zulu(2000, 1, 1, 0, 0, 0, 1), "in 0 seconds"),
        (Zulu(2000, 1, 1, 0, 0, 0, 1), Zulu(2000, 1, 1, 0, 0, 0, 0), "1 second ago"),
    ],
)
...
@parametrize(
    ...
    [
        ...
        (Zulu(2000, 1, 1, 0, 0, 0), Zulu(2000, 1, 1, 0, 0, 1), "1 second ago"),
        (Zulu(2000, 1, 1, 0, 0, 1), Zulu(2000, 1, 1, 0, 0, 0), "in 1 second"),
        (Zulu(2000, 1, 1, 0, 0, 0, 0), Zulu(2000, 1, 1, 0, 0, 0, 1), "1 second ago"),
        (Zulu(2000, 1, 1, 0, 0, 0, 1), Zulu(2000, 1, 1, 0, 0, 0, 0), "in 0 seconds"),
    ],
)
...
@parametrize(
    "dt,other,expected",
    [
        (Zulu(2000, 1, 1), Zulu(2000, 1, 1), True),
        (Zulu(2000, 1, 1), datetime(2000, 1, 1, tzinfo=UTC), True),
        (Zulu(2000, 1, 2), Zulu(2000, 1, 1), False),
        (Zulu(2000, 1, 2), datetime(2000, 1, 1, tzinfo=UTC), False),
    ],
)
...
@parametrize(
    "dt,other,expected",
    [
        (Zulu(2000, 1, 1), Zulu(2000, 1, 1), False),
        (Zulu(2000, 1, 1), datetime(2000, 1, 1, tzinfo=UTC), False),
        (Zulu(2000, 1, 2), Zulu(2000, 1, 1), True),
        (Zulu(2000, 1, 2), datetime(2000, 1, 1, tzinfo=UTC), True),
    ],
)
...
@parametrize(
    "dt,other,expected",
    [
        (Zulu(2000, 1, 1, 12, 30, 45, 15), Zulu(2000, 1, 1, 12, 30), False),
        (
            Zulu(2000, 1, 1, 12, 30, 45, 15),
            datetime(2000, 1, 1, 12, 30, tzinfo=UTC),
            False,
        ),
        (Zulu(2000, 1, 1, 12, 30), Zulu(2000, 1, 1, 12, 30, 45, 15), True),
        (
            Zulu(2000, 1, 1, 12, 30),
...
@parametrize(
    ...
    [
        ...
        (Zulu(2000, 1, 1, 12, 30), Zulu(2000, 1, 1, 12, 30), True),
        (Zulu(2000, 1, 1, 12, 30), datetime(2000, 1, 1, 12, 30, tzinfo=UTC), True),
    ],
)
...
@parametrize(
    "dt,other,expected",
    [
        (Zulu(2000, 1, 1, 12, 30, 45, 15), Zulu(2000, 1, 1, 12, 30), True),
        (
            Zulu(2000, 1, 1, 12, 30, 45, 15),
            datetime(2000, 1, 1, 12, 30, tzinfo=UTC),
            True,
        ),
        (Zulu(2000, 1, 1, 12, 30), Zulu(2000, 1, 1, 12, 30, 45, 15), False),
        (
            Zulu(2000, 1, 1, 12, 30),
            datetime(2000, 1, 1, 12, 30, 45, 15, tzinfo=UTC),
            False,
...
@parametrize(
    "dt,frame,expected",
    [
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "second", Zulu(2015, 2, 5, 12, 30, 15)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "minute", Zulu(2015, 2, 5, 12, 30)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "hour", Zulu(2015, 2, 5, 12)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "day", Zulu(2015, 2, 5)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "week", Zulu(2015, 2, 2)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "month", Zulu(2015, 2, 1)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "year", Zulu(2015, 1, 1)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "decade", Zulu(2010, 1, 1)),
        (Zulu(2015, 2, 5, 12, 30, 15, 123456), "century", Zulu(2000, 1, 1)),
    ],
)
...
@parametrize(
    "dt,span,count,expected",
    [
        (
            Zulu(2015, 4, 4, 12, 30),
            "century",
            1,
            (Zulu(2000, 1, 1, 0, 0), Zulu(2099, 12, 31, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "decade",
            1,
            (Zulu(2010, 1, 1, 0, 0), Zulu(2019, 12, 31, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "century",
            3,
            (Zulu(2000, 1, 1, 0, 0), Zulu(2299, 12, 31, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "decade",
            3,
            (Zulu(2010, 1, 1, 0, 0), Zulu(2039, 12, 31, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "year",
            1,
            (Zulu(2015, 1, 1, 0, 0), Zulu(2015, 12, 31, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "month",
            1,
            (Zulu(2015, 4, 1, 0, 0), Zulu(2015, 4, 30, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "week",
            3,
            (Zulu(2015, 3, 30, 0, 0), Zulu(2015, 4, 19, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "day",
            3,
            (Zulu(2015, 4, 4, 0, 0), Zulu(2015, 4, 6, 23, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "hour",
            2,
            (Zulu(2015, 4, 4, 12, 0), Zulu(2015, 4, 4, 13, 59, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30),
            "minute",
            5,
            (Zulu(2015, 4, 4, 12, 30, 0), Zulu(2015, 4, 4, 12, 34, 59, 999999)),
        ),
        (
            Zulu(2015, 4, 4, 12, 30, 47),
            "second",
            20,
            (Zulu(2015, 4, 4, 12, 30, 47, 0), Zulu(2015, 4, 4, 12, 31, 6, 999999)),
        ),
    ],
)
...
@parametrize(
    ...
    [
        (
            ...
            [
                (Zulu(2000, 1, 1, 0, 0), Zulu(2099, 12, 31, 23, 59, 59, 999999)),
                (Zulu(2100, 1, 1, 0, 0), Zulu(2199, 12, 31, 23, 59, 59, 999999)),
            ],
        ),
        (
            "decade",
            ...
            [
                (Zulu(2010, 1, 1, 0, 0), Zulu(2019, 12, 31, 23, 59, 59, 999999)),
                (Zulu(2020, 1, 1, 0, 0), Zulu(2029, 12, 31, 23, 59, 59, 999999)),
                (Zulu(2030, 1, 1, 0, 0), Zulu(2039, 12, 31, 23, 59, 59, 999999)),
            ],
        ),
        (
            "year",
            ...
            [
                (Zulu(2015, 1, 1, 0, 0), Zulu(2015, 12, 31, 23, 59, 59, 999999)),
                (Zulu(2016, 1, 1, 0, 0), Zulu(2016, 12, 31, 23, 59, 59, 999999)),
                (Zulu(2017, 1, 1, 0, 0), Zulu(2017, 12, 31, 23, 59, 59, 999999)),
            ],
        ),
        (
            "month",
            ...
            [
                (Zulu(2015, 4, 1, 0, 0), Zulu(2015, 4, 30, 23, 59, 59, 999999)),
                (Zulu(2015, 5, 1, 0, 0), Zulu(2015, 5, 31, 23, 59, 59, 999999)),
                (Zulu(2015, 6, 1, 0, 0), Zulu(2015, 6, 30, 23, 59, 59, 999999)),
                (Zulu(2015, 7, 1, 0, 0), Zulu(2015, 7, 31, 23, 59, 59, 999999)),
            ],
        ),
        (
            "week",
            Zulu(2015, 4, 4, 12, 30),
            Zulu(2015, 4, 21, 12, 30),
            [
                (Zulu(2015, 3, 30, 0, 0), Zulu(2015, 4, 5, 23, 59, 59, 999999)),
                (Zulu(2015, 4, 6, 0, 0), Zulu(2015, 4, 12, 23, 59, 59, 999999)),
                (Zulu(2015, 4, 13, 0, 0), Zulu(2015, 4, 19, 23, 59, 59, 999999)),
            ],
        ),
        (
            "day",
            ...
            Zulu(2015, 4, 8, 12, 30),
            [
                (Zulu(2015, 4, 4, 0, 0), Zulu(2015, 4, 4, 23, 59, 59, 999999)),
                (Zulu(2015, 4, 5, 0, 0), Zulu(2015, 4, 5, 23, 59, 59, 999999)),
                (Zulu(2015, 4, 6, 0, 0), Zulu(2015, 4, 6, 23, 59, 59, 999999)),
                (Zulu(2015, 4, 7, 0, 0), Zulu(2015, 4, 7, 23, 59, 59, 999999)),
            ],
        ),
        (
            "hour",
            ...
            Zulu(2015, 4, 4, 16, 30),
            [
                (Zulu(2015, 4, 4, 12, 0), Zulu(2015, 4, 4, 12, 59, 59, 999999)),
                (Zulu(2015, 4, 4, 13, 0), Zulu(2015, 4, 4, 13, 59, 59, 999999)),
                (Zulu(2015, 4, 4, 14, 0), Zulu(2015, 4, 4, 14, 59, 59, 999999)),
                (Zulu(2015, 4, 4, 15, 0), Zulu(2015, 4, 4, 15, 59, 59, 999999)),
            ],
        ),
        (
            "minute",
            ...
            [
                (Zulu(2015, 4, 4, 12, 30, 0), Zulu(2015, 4, 4, 12, 30, 59, 999999)),
                (Zulu(2015, 4, 4, 12, 31, 0), Zulu(2015, 4, 4, 12, 31, 59, 999999)),
                (Zulu(2015, 4, 4, 12, 32, 0), Zulu(2015, 4, 4, 12, 32, 59, 999999)),
                (Zulu(2015, 4, 4, 12, 33, 0), Zulu(2015, 4, 4, 12, 33, 59, 999999)),
            ],
        ),
        (
            "second",
            ...
            [
                (Zulu(2015, 4, 4, 12, 30, 1, 0), Zulu(2015, 4, 4, 12, 30, 1, 999999)),
                (Zulu(2015, 4, 4, 12, 30, 2, 0), Zulu(2015, 4, 4, 12, 30, 2, 999999)),
                (Zulu(2015, 4, 4, 12, 30, 3, 0), Zulu(2015, 4, 4, 12, 30, 3, 999999)),
                (Zulu(2015, 4, 4, 12, 30, 4, 0), Zulu(2015, 4, 4, 12, 30, 4, 999999)),
            ],
        ),
        ("second", Zulu(2015, 4, 4, 12, 30, 5), Zulu(2015, 4, 4, 12, 30, 1), []),
    ],
)
...
@parametrize(
    ...
    [
        (
            ...
            Zulu(2015, 4, 4, 12, 30),
            Zulu(2215, 4, 4, 12, 30),
            [Zulu(2015, 4, 4, 12, 30), Zulu(2115, 4, 4, 12, 30)],
        ),
        (
            "decade",
            Zulu(2015, 4, 4, 12, 30),
        ...
        (
            "week",
            Zulu(2015, 4, 4, 12, 30),
            Zulu(2015, 4, 26, 12, 30),
            [
                Zulu(2015, 4, 4, 12, 30),
                Zulu(2015, 4, 11, 12, 30),
                Zulu(2015, 4, 18, 12, 30),
            ],
        ),
        (
            "day",
        ...
        ("second", Zulu(2015, 4, 4, 12, 30, 3), Zulu(2015, 4, 4, 12, 30, 0), []),
    ],
)

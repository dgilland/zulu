...
3. The pull request should work for all versions Python that this project supports. Check https://travis-ci.org/dgilland/zulu/pull_requests and make sure that the all environments pass.
